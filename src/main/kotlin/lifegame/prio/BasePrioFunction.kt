...
class BasePrioFunction(private val algo: PrioAlgo) {
    ...
    private fun carryingTwoUndiagnosedSamples(algo: PrioAlgo): Boolean {
    ...
    private fun setBasePrio(possibleActions: List<PrioAction>, algo: PrioAlgo) {
